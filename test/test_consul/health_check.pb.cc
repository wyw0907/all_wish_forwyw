...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_health_5fcheck_2eproto[2];
static const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* file_level_enum_descriptors_health_5fcheck_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_health_5fcheck_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_health_5fcheck_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_health_5fcheck_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "HealthCheckRequest\022\017\n\007service\030\001 \001(\t\"\247\001\n\023"
  "HealthCheckResponse\022A\n\006status\030\001 \001(\01621.gr"
  "pc.health.v1.HealthCheckResponse.Service"
  "Status\"M\n\rServiceStatus\022\n\n\006UNKOWN\020\000\022\013\n\007S"
  "ERVING\020\001\022\017\n\013NOT_SERVING\020\002\022\022\n\016SERVICE_UNK"
  "OWN\020\0032\256\001\n\006Health\022P\n\005Check\022\".grpc.health."
  "v1.HealthCheckRequest\032#.grpc.health.v1.H"
  "ealthCheckResponse\022R\n\005Watch\022\".grpc.healt"
  "h.v1.HealthCheckRequest\032#.grpc.health.v1"
  ".HealthCheckResponse0\001b\006proto3"
  ;
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_health_5fcheck_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_health_5fcheck_2eproto = {
  false, false, 430, descriptor_table_protodef_health_5fcheck_2eproto, "health_check.proto", 
  ...
  file_level_metadata_health_5fcheck_2eproto, file_level_enum_descriptors_health_5fcheck_2eproto, file_level_service_descriptors_health_5fcheck_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK ::PROTOBUF_NAMESPACE_ID::Metadata
descriptor_table_health_5fcheck_2eproto_metadata_getter(int index) {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_health_5fcheck_2eproto);
  return descriptor_table_health_5fcheck_2eproto.file_level_metadata[index];
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_health_5fcheck_2eproto(&descriptor_table_health_5fcheck_2eproto);
namespace grpc {
namespace health {
namespace v1 {
...
constexpr HealthCheckResponse_ServiceStatus HealthCheckResponse::UNKOWN;
constexpr HealthCheckResponse_ServiceStatus HealthCheckResponse::SERVING;
constexpr HealthCheckResponse_ServiceStatus HealthCheckResponse::NOT_SERVING;
constexpr HealthCheckResponse_ServiceStatus HealthCheckResponse::SERVICE_UNKOWN;
constexpr HealthCheckResponse_ServiceStatus HealthCheckResponse::ServiceStatus_MIN;
constexpr HealthCheckResponse_ServiceStatus HealthCheckResponse::ServiceStatus_MAX;
constexpr int HealthCheckResponse::ServiceStatus_ARRAYSIZE;
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 8)) {
          ...
          CHK_(ptr);
          _internal_set_status(static_cast<::grpc::health::v1::HealthCheckResponse_ServiceStatus>(val));
        } else goto handle_unusual;
        continue;
      default: {
      handle_unusual:
