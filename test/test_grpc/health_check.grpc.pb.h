   ...
   public:
    ...
    class experimental_async_interface {
     public:
      ...
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      virtual void Watch(::grpc::ClientContext* context, ::grpc::health::v1::HealthCheckRequest* request, ::grpc::ClientReadReactor< ::grpc::health::v1::HealthCheckResponse>* reactor) = 0;
      #else
      virtual void Watch(::grpc::ClientContext* context, ::grpc::health::v1::HealthCheckRequest* request, ::grpc::experimental::ClientReadReactor< ::grpc::health::v1::HealthCheckResponse>* reactor) = 0;
      #endif
    };
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
   ...
   public:
    ...
    class experimental_async final :
     ...
     public:
      ...
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      void Watch(::grpc::ClientContext* context, ::grpc::health::v1::HealthCheckRequest* request, ::grpc::ClientReadReactor< ::grpc::health::v1::HealthCheckResponse>* reactor) override;
      #else
      void Watch(::grpc::ClientContext* context, ::grpc::health::v1::HealthCheckRequest* request, ::grpc::experimental::ClientReadReactor< ::grpc::health::v1::HealthCheckResponse>* reactor) override;
      #endif
     private:
      friend class Stub;
